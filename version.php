...
$plugin->version   = 2014091300;        // The current plugin version (Date: YYYYMMDDXX).
...
$plugin->release = 'v2.7-rc2'; // This is our second release candidate for the Moodle 2.7.x branch.
