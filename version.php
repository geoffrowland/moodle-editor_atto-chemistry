...
$plugin->version   = 2014091400;        // The current plugin version (Date: YYYYMMDDXX).
...
$plugin->release = 'v2.7-rc3'; // This is our third release candidate for the Moodle 2.7.x branch.
