...
$plugin->version   = 2014091900;        // The current plugin version (Date: YYYYMMDDXX).
...
$plugin->release = 'v2.7-rc4'; // This is our forth release candidate for the Moodle 2.7.x branch.
