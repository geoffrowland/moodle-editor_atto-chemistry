...
$plugin->version   = 2014100500;        // The current plugin version (Date: YYYYMMDDXX).
...
$plugin->release = 'v2.7-2'; // This is the second stable release for the Moodle 2.7.x branch.
